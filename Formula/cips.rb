...
class Cips < Formula
  ...
  url "https://github.com/CodeTonight-SA/cips/releases/download/v5.0.0/cips-5.0.0.tar.gz"
  sha256 "2d1302c12106625681c84d5b31713bda1e4dea48a473f59c1cfe9de0f4f761b8"
  license "Apache-2.0"
  version "5.0.0"
